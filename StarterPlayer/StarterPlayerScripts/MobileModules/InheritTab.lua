...
-- THE FIX: Grab the Effects Manager correctly on Mobile
...
function InheritTab.Init(parentFrame, tooltipMgr)
	...
	ContentWrapper.Size = UDim2.new(1, 0, 1, -50); ContentWrapper.Position = UDim2.new(0, 0, 0, 50); ContentWrapper.BackgroundTransparency = 1
	ContentWrapper.LayoutOrder = 1
	local layout = Instance.new("UIListLayout", ContentWrapper); layout.Padding = UDim.new(0, 15); layout.HorizontalAlignment = Enum.HorizontalAlignment.Center; layout.FillDirection = Enum.FillDirection.Vertical

	local function CreateGachaPanel(gType)
		local Panel = Instance.new("Frame", ContentWrapper)
		Panel.Size = UDim2.new(0.95, 0, 0, 500) -- Locked Mobile Height
		...
		ListContainer.Size = UDim2.new(1, -20, 0.55, 0); ListContainer.Position = UDim2.new(0, 10, 0, 35); ListContainer.BackgroundTransparency = 1; ListContainer.ScrollBarThickness = 2; ListContainer.AutomaticCanvasSize = Enum.AutomaticSize.Y
		...
		BottomArea.Size = UDim2.new(1, 0, 0.40, 0); BottomArea.Position = UDim2.new(0, 0, 0.60, 0); BottomArea.BackgroundTransparency = 1

		local ResultLbl = Instance.new("TextLabel", BottomArea)
		ResultLbl.Size = UDim2.new(1, 0, 0, 25); ResultLbl.Position = UDim2.new(0, 0, 0, 0); ResultLbl.BackgroundTransparency = 1; ResultLbl.Font = Enum.Font.GothamBlack; ResultLbl.TextColor3 = Color3.fromRGB(255, 255, 255); ResultLbl.TextSize = 16; ResultLbl.RichText = true; ResultLbl.Text = "Current: None"
		...
		for i = 1, 6 do
			...
			sBtn.Size = UDim2.new(0.14, 0, 1, 0); sBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 30); sBtn.Font = Enum.Font.GothamBold; sBtn.TextColor3 = Color3.fromRGB(200, 200, 200); sBtn.TextScaled = true; sBtn.Text = "Empty"
		...
		RollActions.Size = UDim2.new(0.9, 0, 0, 40); RollActions.Position = UDim2.new(0.05, 0, 0.65, 0); RollActions.BackgroundTransparency = 1
	...
	local tResult, tPity, tRoll, _, tAuto, tStores = CreateGachaPanel("Titan")
	local cResult, cPity, cRoll, _, cAuto, cStores = CreateGachaPanel("Clan")
